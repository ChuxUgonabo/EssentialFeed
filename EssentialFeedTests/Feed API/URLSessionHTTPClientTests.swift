...
//  EssentialFeedTests
//
//  Created by Chux Ugonabo MacBook on 2023-03-14.
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_performsGETRequestWithURL() {
        ...
        URLProtocolStub.observeReaquests { request in
    ...
    private func resultValueFor(data: Data?, response: URLResponse?, error: Error?, file: StaticString = #filePath, line: UInt = #line) -> (data: Data, response: HTTPURLResponse)? {
        ...
        default:
            XCTFail("Expected succcess, got \(result) instead", file: file, line: line)
            return nil
        }
    }
    ...
    private class URLProtocolStub: URLProtocol {
        ...
        static func observeReaquests(observer: @escaping (URLRequest) -> Void) {
